...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shfit_size=0,
    ...
    def forward(self, x):
        ...
        shfited_x = window_reverse(attn_windows, self.window_size, H, W) # B H` W` C
    ...
    def extra_repr(self) -> str:
        return f"dim={self.dim}, input_resolution={self.input_resolution}, num_heads={self.num_heads},"\
               f"window_size={self.window_size}, shfit_size={self.shift_size}, mlp_ratio={self.mlp_ratio}"
